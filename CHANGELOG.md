...
## [2.0.0](https://github.com/andreaslind01/keptn/compare/v1.4.2...2.0.0) (2023-09-12)
...
* **cli:** Introduce `--data` option for `trigger sequence` command ([#8830](https://github.com/andreaslind01/keptn/issues/8830)) ([50b602e](https://github.com/andreaslind01/keptn/commit/50b602e2791f96764760728b122e685c1d600e76))
...
* Introduce tolerations and affinities for helm charts ([#8858](https://github.com/andreaslind01/keptn/issues/8858)) ([d7eb20a](https://github.com/andreaslind01/keptn/commit/d7eb20a9fa9a216b876feaf3b58cbcd96d046c88))
...
* **resource-service:** Compute git auth method once per API request ([#8824](https://github.com/andreaslind01/keptn/issues/8824)) ([2ebdc86](https://github.com/andreaslind01/keptn/commit/2ebdc8613e3f0a1436ae597ce3f0e91dfb35e429))
...
* **resource-service:** reduce git fetch operations ([#9410](https://github.com/andreaslind01/keptn/issues/9410)) ([4a2b091](https://github.com/andreaslind01/keptn/commit/4a2b091aac9006cfc0343db8eb3cf215f6557feb))
...
* **cli:** Fix non deterministic processing of `trigger sequence --data` flag ([#9040](https://github.com/andreaslind01/keptn/issues/9040)) ([4987bc3](https://github.com/andreaslind01/keptn/commit/4987bc384612202569fdd2742004ec552c3d6305))
...
* Resolve security scan issues ([#9094](https://github.com/andreaslind01/keptn/issues/9094)) ([d50bfde](https://github.com/andreaslind01/keptn/commit/d50bfde5cb37ee26fecbdac5d508681f61c6be9a))
...
* **resource-service:** Determine default branch from helm value when repository is not initialized ([#8843](https://github.com/andreaslind01/keptn/issues/8843)) ([8e91639](https://github.com/andreaslind01/keptn/commit/8e916394247c957c9f029e651f6d345315b37979))
...
* **resource-service:** Map go-git specific error types to Keptn error types understood by the resource service error handler ([#8849](https://github.com/andreaslind01/keptn/issues/8849)) ([75a1314](https://github.com/andreaslind01/keptn/commit/75a1314c1fbfab6040346b98bfb8e13331a7c460))
...
* **resource-service:** Return specific error in when creating a project with an initialized repository ([#8855](https://github.com/andreaslind01/keptn/issues/8855)) ([2f7e1f2](https://github.com/andreaslind01/keptn/commit/2f7e1f273ab0df258fac3a493d4fde9947b86f18))
...
* **shipyard-controller:** Adopt previous value of IsUpstreamAutoProvisioned when migrating project with old git credentials structure ([#8882](https://github.com/andreaslind01/keptn/issues/8882)) ([f64441d](https://github.com/andreaslind01/keptn/commit/f64441d9148fd1398fa187969c8e9d37649fb347))
...
* **webhook-service:** RAdd warning for malformed configuration ([#8841](https://github.com/andreaslind01/keptn/issues/8841)) ([6a432b2](https://github.com/andreaslind01/keptn/commit/6a432b2d331659544755b3a10c33fc73f604507a))
...
* Fix dependencies with go mod tidy ([e71a566](https://github.com/andreaslind01/keptn/commit/e71a566de2060c25249bc6242619bdf46012f55b))
...
* **installer:** Adapt resource limits ([#8840](https://github.com/andreaslind01/keptn/issues/8840)) ([e741bbe](https://github.com/andreaslind01/keptn/commit/e741bbe93150ab3df936e2324f6f716947085c59))
* **installer:** Improve resource limits/requests ([#8862](https://github.com/andreaslind01/keptn/issues/8862)) ([a37aa40](https://github.com/andreaslind01/keptn/commit/a37aa40f45ed5c5c7d10e2d7863fcbecda3d08bd))
...
* **mongodb-datastore:** Clean up logs ([#9170](https://github.com/andreaslind01/keptn/issues/9170)) ([08eb880](https://github.com/andreaslind01/keptn/commit/08eb8806c4bc641e52bdce2aa1f5265500099b15))
...
* **deps:** Auto-update go-utils to latest version ([#8888](https://github.com/andreaslind01/keptn/issues/8888)) ([0c6f063](https://github.com/andreaslind01/keptn/commit/0c6f063bad75b1643223475da378055a9bd3cf42))
...
* **deps:** update actions/cache action to v3.2.1 ([#9373](https://github.com/andreaslind01/keptn/issues/9373)) ([13ec4d0](https://github.com/andreaslind01/keptn/commit/13ec4d0d07b5153f3794dbc37571272135c8d36e))
...
* **deps:** update c-py/action-dotenv-to-setenv action to v4 ([#8898](https://github.com/andreaslind01/keptn/issues/8898)) ([3d6ea7c](https://github.com/andreaslind01/keptn/commit/3d6ea7cf5b2eb7ea05994d5e7bb858b8a72273ce))
...
* **deps:** update dawidd6/action-download-artifact action to v2.24.3 ([#9402](https://github.com/andreaslind01/keptn/issues/9402)) ([6e3cb6b](https://github.com/andreaslind01/keptn/commit/6e3cb6be9d44b5216d198251cdd23945bb9c68b2))
...
* **deps:** update dependency @types/express to v4.17.14 ([#8851](https://github.com/andreaslind01/keptn/issues/8851)) ([9c1abae](https://github.com/andreaslind01/keptn/commit/9c1abae1fb40271f6bafd892fcda6b7fec72fb04))
...
* **deps:** update dependency @types/lodash to v4.14.185 ([#8845](https://github.com/andreaslind01/keptn/issues/8845)) ([ba12d52](https://github.com/andreaslind01/keptn/commit/ba12d52b898b99086ceeeceacc56b0872b9d4485))
...
* **deps:** update dependency @types/marked to v4.0.7 ([#8846](https://github.com/andreaslind01/keptn/issues/8846)) ([9782acf](https://github.com/andreaslind01/keptn/commit/9782acf6f31e3969a82999e1b887e7e671f0aa4b))
...
* **deps:** update dependency @types/node to v14.18.28 ([#8811](https://github.com/andreaslind01/keptn/issues/8811)) ([1ee8bc0](https://github.com/andreaslind01/keptn/commit/1ee8bc02d64a7065e0347b19fb7506adbc1f0544))
...
* **deps:** update dependency cypress to v10.11.0 ([#9069](https://github.com/andreaslind01/keptn/issues/9069)) ([216b767](https://github.com/andreaslind01/keptn/commit/216b7670f11d266b5edf42e07acb6297f411abed))
...
* **deps:** update dependency nodemon to v2.0.20 ([#8860](https://github.com/andreaslind01/keptn/issues/8860)) ([e795721](https://github.com/andreaslind01/keptn/commit/e79572125e229f5c334a256c72c9ea3ecb7ad2cb))
...
* **deps:** update dependency yaml to v2.1.3 ([#8952](https://github.com/andreaslind01/keptn/issues/8952)) ([c56cd73](https://github.com/andreaslind01/keptn/commit/c56cd73d6160f1aa381a969d00c32a4d392dd78e))
...
* **deps:** update golang docker tag to v1.18.6 ([#8847](https://github.com/andreaslind01/keptn/issues/8847)) ([9aabade](https://github.com/andreaslind01/keptn/commit/9aabade9d8060571d5de6b3265400be7632abbf9))
...
* **deps:** update golang docker tag to v1.20.5 ([#9695](https://github.com/andreaslind01/keptn/issues/9695)) ([ddc1ab9](https://github.com/andreaslind01/keptn/commit/ddc1ab9e7804e96023a734db14da6b1fd33bc180))
...
* **deps:** update golang.org/x/crypto digest to 35f4265 ([#8865](https://github.com/andreaslind01/keptn/issues/8865)) ([671c074](https://github.com/andreaslind01/keptn/commit/671c0748bb351fc9ab119073d6c2d449a67a3904))
* **deps:** update golang.org/x/crypto digest to 4ba4fb4 ([#8891](https://github.com/andreaslind01/keptn/issues/8891)) ([054606e](https://github.com/andreaslind01/keptn/commit/054606e6c9bf489fec45a6e42580f82ec90a465d))
...
* **deps:** update golang.org/x/exp digest to 439092d ([#8876](https://github.com/andreaslind01/keptn/issues/8876)) ([9a651e5](https://github.com/andreaslind01/keptn/commit/9a651e59c54c1e2d54d75dd7170b2647101cf141))
...
* **deps:** update golang.org/x/exp digest to 5c715a9 ([#8835](https://github.com/andreaslind01/keptn/issues/8835)) ([4c1922e](https://github.com/andreaslind01/keptn/commit/4c1922e81154d5a164d234f8d6660c34f7b690bd))
...
* **deps:** update golang.org/x/exp digest to b168a2c ([#8857](https://github.com/andreaslind01/keptn/issues/8857)) ([b234f8c](https://github.com/andreaslind01/keptn/commit/b234f8c012396143e6a3457b7bb79918f1ffb399))
* **deps:** update golang.org/x/exp digest to c95f2b4 ([#9476](https://github.com/andreaslind01/keptn/issues/9476)) ([6f85c35](https://github.com/andreaslind01/keptn/commit/6f85c3518cdcce065362f15bf500b41a5e6d5e18))
* **deps:** update golang.org/x/exp digest to dc92f86 ([#8854](https://github.com/andreaslind01/keptn/issues/8854)) ([451c0d4](https://github.com/andreaslind01/keptn/commit/451c0d4f8866855e54990a5819c7dc67f7b1d4f3))
...
* **deps:** update golang.org/x/net digest to 8be6392 ([#8889](https://github.com/andreaslind01/keptn/issues/8889)) ([cca9eea](https://github.com/andreaslind01/keptn/commit/cca9eea35d52b2651f8d38965bc2ccb737d576ad))
* **deps:** update golang.org/x/net digest to bea034e ([#8836](https://github.com/andreaslind01/keptn/issues/8836)) ([0cbb585](https://github.com/andreaslind01/keptn/commit/0cbb5855acd90d06c40fa85d87cfe09cdc14f17f))
* **deps:** update golang.org/x/net digest to d0c6ba3 ([#8866](https://github.com/andreaslind01/keptn/issues/8866)) ([afa622e](https://github.com/andreaslind01/keptn/commit/afa622e3d786a281e08643ebb358c3772dee80e3))
* **deps:** update golang.org/x/net digest to d300de1 ([#8877](https://github.com/andreaslind01/keptn/issues/8877)) ([2d1b796](https://github.com/andreaslind01/keptn/commit/2d1b79601a7f75182c495db60315d1c9352828d8))
...
* **deps:** update golang.org/x/oauth2 digest to f213421 ([#8839](https://github.com/andreaslind01/keptn/issues/8839)) ([417cbeb](https://github.com/andreaslind01/keptn/commit/417cbeb3b33c6092af7265eb01d55a36ade23e83))
* **deps:** update golang.org/x/time digest to 2ce7c29 ([#8878](https://github.com/andreaslind01/keptn/issues/8878)) ([c69bba0](https://github.com/andreaslind01/keptn/commit/c69bba0d17940eba021b18b489e12b4d3cd8212a))
* **deps:** update golang.org/x/time digest to f3bd1da ([#8890](https://github.com/andreaslind01/keptn/issues/8890)) ([fd22959](https://github.com/andreaslind01/keptn/commit/fd229596c3ca12d0f371f58f72f6deae408bdd81))
...
* **deps:** update helm release nats to v0.18.0 ([#8894](https://github.com/andreaslind01/keptn/issues/8894)) ([0b31557](https://github.com/andreaslind01/keptn/commit/0b31557983fa84cd52d4d9d8089567be030b0002))
...
* **deps:** Update k8s dependencies ([#8887](https://github.com/andreaslind01/keptn/issues/8887)) ([f3b0939](https://github.com/andreaslind01/keptn/commit/f3b09392067f0b104cb39183ea04b5a7d76cbee0))
...
* **deps:** update k8s.io/utils digest to 665eaae ([#8884](https://github.com/andreaslind01/keptn/issues/8884)) ([3454554](https://github.com/andreaslind01/keptn/commit/34545546413d5b34d2335ad6e5ded79376cb3512))
...
* **deps:** Update keptn/go-utils to 8a053e609bfac3125ea2f9eb3bb1d404870bc402 ([0c6f063](https://github.com/andreaslind01/keptn/commit/0c6f063bad75b1643223475da378055a9bd3cf42))
* **deps:** update kubernetes packages to v0.22.14 (patch) ([#8861](https://github.com/andreaslind01/keptn/issues/8861)) ([424567e](https://github.com/andreaslind01/keptn/commit/424567ee2f85007171618990508ead333819e275))
* **deps:** update kubernetes packages to v0.22.15 (patch) ([#8885](https://github.com/andreaslind01/keptn/issues/8885)) ([f82d7c2](https://github.com/andreaslind01/keptn/commit/f82d7c29bcd998f2bdc7c2d6430047bc9686b60d))
...
* **deps:** update libgit2 to 1.5.2-rc0 ([#9536](https://github.com/andreaslind01/keptn/issues/9536)) ([dcfde08](https://github.com/andreaslind01/keptn/commit/dcfde08d000fa05af205ba570c6f83d96d21096d))
...
* **deps:** update module github.com/cloudevents/sdk-go/v2 to v2.12.0 ([#8965](https://github.com/andreaslind01/keptn/issues/8965)) ([3dc93f7](https://github.com/andreaslind01/keptn/commit/3dc93f72584e9bee89ad8cce6bf9742fc44e4c4b))
* **deps:** update module github.com/cloudevents/sdk-go/v2 to v2.13.0 ([#9431](https://github.com/andreaslind01/keptn/issues/9431)) ([b0c9cec](https://github.com/andreaslind01/keptn/commit/b0c9cecec34956733cb787ba5fc13fbf05e1770d))
* **deps:** update module github.com/cloudevents/sdk-go/v2 to v2.14.0 ([#9633](https://github.com/andreaslind01/keptn/issues/9633)) ([c24c5dd](https://github.com/andreaslind01/keptn/commit/c24c5dd1e00118b1099944cc40743fd4830f053f))
* **deps:** update module github.com/docker/docker-credential-helpers to v0.7.0 ([#8966](https://github.com/andreaslind01/keptn/issues/8966)) ([070342e](https://github.com/andreaslind01/keptn/commit/070342e4eac8c8d0ad7cc6a692b57bd06aed173e))
* **deps:** update module github.com/gin-gonic/gin to v1.8.2 ([#9376](https://github.com/andreaslind01/keptn/issues/9376)) ([fd40fbc](https://github.com/andreaslind01/keptn/commit/fd40fbc2a86f2af52ca418815d04fa4d3c10b263))
* **deps:** update module github.com/gin-gonic/gin to v1.9.1 [security] ([6b8fb3f](https://github.com/andreaslind01/keptn/commit/6b8fb3f5420fbcf6c88b55380e49ef144e4d46a7))
* **deps:** update module github.com/go-git/go-billy/v5 to v5.4.0 ([#9387](https://github.com/andreaslind01/keptn/issues/9387)) ([e59a847](https://github.com/andreaslind01/keptn/commit/e59a84790ffd678c5af6eb6041b0b5d298c5546b))
* **deps:** update module github.com/go-openapi/runtime to v0.26.0 ([#9637](https://github.com/andreaslind01/keptn/issues/9637)) ([7f3d516](https://github.com/andreaslind01/keptn/commit/7f3d516c794cf1a72ed39d48f758dbde3ffd0ec4))
* **deps:** update module github.com/go-openapi/spec to v0.20.9 ([#9650](https://github.com/andreaslind01/keptn/issues/9650)) ([411980e](https://github.com/andreaslind01/keptn/commit/411980e0acfef21abcc053bb1351875956a9108e))
* **deps:** update module github.com/go-test/deep to v1.0.9 ([#9345](https://github.com/andreaslind01/keptn/issues/9345)) ([76327db](https://github.com/andreaslind01/keptn/commit/76327db93aa0fb70da736a7743ee011c163d45b0))
* **deps:** update module github.com/go-test/deep to v1.1.0 ([#9363](https://github.com/andreaslind01/keptn/issues/9363)) ([7f4f4c8](https://github.com/andreaslind01/keptn/commit/7f4f4c8d39cdd4b97f151fc8f8349b4281b49841))
* **deps:** update module github.com/gobuffalo/packr/v2 to v2.8.3 ([#8798](https://github.com/andreaslind01/keptn/issues/8798)) ([d19ce34](https://github.com/andreaslind01/keptn/commit/d19ce34904bce5dd8b44d62fd7cf2e9a920020d7))
* **deps:** update module github.com/invopop/jsonschema to v0.7.0 ([#9293](https://github.com/andreaslind01/keptn/issues/9293)) ([fa3e387](https://github.com/andreaslind01/keptn/commit/fa3e3874b2c3ebcf0e9c8dec499c56a2b5359b38))
* **deps:** update module github.com/libgit2/git2go/v33 to v33.0.9 ([#9271](https://github.com/andreaslind01/keptn/issues/9271)) ([1d7857e](https://github.com/andreaslind01/keptn/commit/1d7857e3d5fcb9f586a46f3dd22183648a36ad57))
* **deps:** update module github.com/moby/moby/v20 to v20.10.22 ([#9346](https://github.com/andreaslind01/keptn/issues/9346)) ([d509689](https://github.com/andreaslind01/keptn/commit/d50968985634235ed7cff6964e4569ccc708a69b))
* **deps:** update module github.com/moby/moby/v20 to v20.10.23 ([#9450](https://github.com/andreaslind01/keptn/issues/9450)) ([89e8ea6](https://github.com/andreaslind01/keptn/commit/89e8ea6f71bc9ef91df539fd88da7ae6b8b78330))
* **deps:** update module github.com/nats-io/nats-server/v2 to v2.9.10 ([#9353](https://github.com/andreaslind01/keptn/issues/9353)) ([aaad0d3](https://github.com/andreaslind01/keptn/commit/aaad0d31ff43df762be733e58270fb4ab928e13d))
* **deps:** update module github.com/nats-io/nats-server/v2 to v2.9.11 ([#9408](https://github.com/andreaslind01/keptn/issues/9408)) ([da65b02](https://github.com/andreaslind01/keptn/commit/da65b02cbf4b3ed803d3990ab9189de59104442a))
* **deps:** update module github.com/nats-io/nats-server/v2 to v2.9.16 ([#9635](https://github.com/andreaslind01/keptn/issues/9635)) ([f0edf71](https://github.com/andreaslind01/keptn/commit/f0edf717269901561fbbc1e9d886e04a613902e8))
* **deps:** update module github.com/nats-io/nats-server/v2 to v2.9.17 ([f359305](https://github.com/andreaslind01/keptn/commit/f3593052b0e7218f2b29a50d076cfd144c66013b))
* **deps:** update module github.com/nats-io/nats-server/v2 to v2.9.9 ([#9347](https://github.com/andreaslind01/keptn/issues/9347)) ([20b722d](https://github.com/andreaslind01/keptn/commit/20b722def56b522789c59e919037047ec7ee3aa9))
* **deps:** update module github.com/nats-io/nats.go to v1.21.0 ([#9297](https://github.com/andreaslind01/keptn/issues/9297)) ([195fe42](https://github.com/andreaslind01/keptn/commit/195fe42a7fcad9b3ba2ea55e70fe988c6a47f964))
* **deps:** update module github.com/nats-io/nats.go to v1.22.1 ([#9371](https://github.com/andreaslind01/keptn/issues/9371)) ([14ea937](https://github.com/andreaslind01/keptn/commit/14ea937cd4161d38ffda88257348dd83c334a0c7))
* **deps:** update module github.com/nats-io/nats.go to v1.25.0 ([#9607](https://github.com/andreaslind01/keptn/issues/9607)) ([0d527c7](https://github.com/andreaslind01/keptn/commit/0d527c791f5d8ec3deccd7641a04d29599d12041))
* **deps:** update module github.com/otiai10/copy to v1.11.0 ([#9640](https://github.com/andreaslind01/keptn/issues/9640)) ([fec1f4c](https://github.com/andreaslind01/keptn/commit/fec1f4c10b5074a95ae65e30b36bf07f022fca7a))
* **deps:** update module github.com/sirupsen/logrus to v1.9.0 ([#8945](https://github.com/andreaslind01/keptn/issues/8945)) ([3848cbd](https://github.com/andreaslind01/keptn/commit/3848cbd99bcdadb4a229de5be9e1442c3a8d2f60))
* **deps:** update module github.com/sirupsen/logrus to v1.9.2 ([6b8fb3f](https://github.com/andreaslind01/keptn/commit/6b8fb3f5420fbcf6c88b55380e49ef144e4d46a7))
* **deps:** update module github.com/sirupsen/logrus to v1.9.3 ([f359305](https://github.com/andreaslind01/keptn/commit/f3593052b0e7218f2b29a50d076cfd144c66013b))
* **deps:** update module github.com/spf13/viper to v1.13.0 ([#8838](https://github.com/andreaslind01/keptn/issues/8838)) ([fe3ec7c](https://github.com/andreaslind01/keptn/commit/fe3ec7cc56943c74ff980c380d856561d68be441))
* **deps:** update module github.com/spf13/viper to v1.14.0 ([#9222](https://github.com/andreaslind01/keptn/issues/9222)) ([891e2a3](https://github.com/andreaslind01/keptn/commit/891e2a319125732c05bf863740341519bea040be))
* **deps:** update module github.com/stretchr/testify to v1.8.4 ([f359305](https://github.com/andreaslind01/keptn/commit/f3593052b0e7218f2b29a50d076cfd144c66013b))
* **deps:** update module github.com/swaggo/swag to v1.16.1 ([#9638](https://github.com/andreaslind01/keptn/issues/9638)) ([163125c](https://github.com/andreaslind01/keptn/commit/163125cdfae74b3b8d24bf63e09dbf1f9489a05f))
* **deps:** update module github.com/swaggo/swag to v1.8.10 ([#9472](https://github.com/andreaslind01/keptn/issues/9472)) ([87bfeff](https://github.com/andreaslind01/keptn/commit/87bfeff29482edcadfe4e8d3986d7354403289b7))
* **deps:** update module github.com/swaggo/swag to v1.8.6 ([#8867](https://github.com/andreaslind01/keptn/issues/8867)) ([c966bd0](https://github.com/andreaslind01/keptn/commit/c966bd0baded8770049aa5a62d16ea9ef4f8cef9))
* **deps:** update module github.com/swaggo/swag to v1.8.7 ([#9052](https://github.com/andreaslind01/keptn/issues/9052)) ([ef3ccec](https://github.com/andreaslind01/keptn/commit/ef3ccecccc6144c7d35b2a9b00e38ee1fdfa5543))
* **deps:** update module github.com/swaggo/swag to v1.8.8 ([#9272](https://github.com/andreaslind01/keptn/issues/9272)) ([f701ebb](https://github.com/andreaslind01/keptn/commit/f701ebb849e41c8977b04e1d7fa711e1ee100f6f))
* **deps:** update module github.com/swaggo/swag to v1.8.9 ([#9348](https://github.com/andreaslind01/keptn/issues/9348)) ([ccd450d](https://github.com/andreaslind01/keptn/commit/ccd450d723342509efbd0ec10058256e47119368))
* **deps:** update module go.mongodb.org/mongo-driver to v1.10.2 ([#8837](https://github.com/andreaslind01/keptn/issues/8837)) ([0fa7ef5](https://github.com/andreaslind01/keptn/commit/0fa7ef51a12ab7eae800cf65210a26c27137c384))
* **deps:** update module go.mongodb.org/mongo-driver to v1.10.2 ([#8928](https://github.com/andreaslind01/keptn/issues/8928)) ([7d2c84a](https://github.com/andreaslind01/keptn/commit/7d2c84af600e24bc7e6c71c8250d3f87762d027e))
* **deps:** update module go.mongodb.org/mongo-driver to v1.10.3 ([#8954](https://github.com/andreaslind01/keptn/issues/8954)) ([61c41ae](https://github.com/andreaslind01/keptn/commit/61c41ae1edf1365110e8a2346249486fccb67e1b))
* **deps:** update module go.mongodb.org/mongo-driver to v1.11.1 ([#9354](https://github.com/andreaslind01/keptn/issues/9354)) ([b5e1bcb](https://github.com/andreaslind01/keptn/commit/b5e1bcbfb45fa1a4ac7d6d80d17957ea59af1c49))
* **deps:** update module go.mongodb.org/mongo-driver to v1.11.6 ([#9663](https://github.com/andreaslind01/keptn/issues/9663)) ([39feb88](https://github.com/andreaslind01/keptn/commit/39feb8880d7f999de5fd71e1e136ac3933ebb694))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.37.0 ([#9298](https://github.com/andreaslind01/keptn/issues/9298)) ([df05174](https://github.com/andreaslind01/keptn/commit/df05174b694fa22768ce9bbbf584277ff350a649))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.41.1 ([#9655](https://github.com/andreaslind01/keptn/issues/9655)) ([1d40f60](https://github.com/andreaslind01/keptn/commit/1d40f60f90a8c8be05086a5854fe19261015c82d))
* **deps:** update module golang.org/x/crypto to v0.4.0 ([#9304](https://github.com/andreaslind01/keptn/issues/9304)) ([c384484](https://github.com/andreaslind01/keptn/commit/c38448472cd174dce81b577d7dc37a98dd7e2d3a))
* **deps:** update module golang.org/x/crypto to v0.6.0 ([#9457](https://github.com/andreaslind01/keptn/issues/9457)) ([fa66f33](https://github.com/andreaslind01/keptn/commit/fa66f337aeaeeb040b4e59d7303a2faa1d382269))
* **deps:** update module golang.org/x/crypto to v0.9.0 ([6b8fb3f](https://github.com/andreaslind01/keptn/commit/6b8fb3f5420fbcf6c88b55380e49ef144e4d46a7))
* **deps:** update module golang.org/x/net to v0.10.0 ([6b8fb3f](https://github.com/andreaslind01/keptn/commit/6b8fb3f5420fbcf6c88b55380e49ef144e4d46a7))
* **deps:** update module golang.org/x/net to v0.4.0 ([#9305](https://github.com/andreaslind01/keptn/issues/9305)) ([78bc05f](https://github.com/andreaslind01/keptn/commit/78bc05f56bd3760e4da634dc7415bb19b1456625))
* **deps:** update module golang.org/x/net to v0.5.0 ([#9399](https://github.com/andreaslind01/keptn/issues/9399)) ([5cbef46](https://github.com/andreaslind01/keptn/commit/5cbef469592b03269f1ee225228efc83cc1ed809))
* **deps:** update module golang.org/x/net to v0.7.0 ([#9551](https://github.com/andreaslind01/keptn/issues/9551)) ([b0b0fcc](https://github.com/andreaslind01/keptn/commit/b0b0fcc1bbb22cd6a93cd1b2bea9388ebd6505fb))
* **deps:** update module golang.org/x/net to v0.7.0 [security] ([#9518](https://github.com/andreaslind01/keptn/issues/9518)) ([68b32c5](https://github.com/andreaslind01/keptn/commit/68b32c57f36edaafe263132b85d775178273dad9))
* **deps:** update module golang.org/x/oauth2 to v0.3.0 ([#9306](https://github.com/andreaslind01/keptn/issues/9306)) ([b8ad40a](https://github.com/andreaslind01/keptn/commit/b8ad40a9775926c3bfe851337e5fe93790aa21ff))
* **deps:** update module golang.org/x/oauth2 to v0.5.0 ([#9458](https://github.com/andreaslind01/keptn/issues/9458)) ([b2a2a0c](https://github.com/andreaslind01/keptn/commit/b2a2a0ca0afdc166cf1cd56a872bcee898705fbc))
* **deps:** update module golang.org/x/oauth2 to v0.8.0 ([6b8fb3f](https://github.com/andreaslind01/keptn/commit/6b8fb3f5420fbcf6c88b55380e49ef144e4d46a7))
* **deps:** update module golang.org/x/text to v0.6.0 ([#9406](https://github.com/andreaslind01/keptn/issues/9406)) ([f690220](https://github.com/andreaslind01/keptn/commit/f690220555dc52b08d677e6b1ccba601eafaefa3))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#9366](https://github.com/andreaslind01/keptn/issues/9366)) ([f768521](https://github.com/andreaslind01/keptn/commit/f7685212905be3301899a4797d0ceb4582523d35))
* **deps:** update module k8s.io/apimachinery to v0.25.6 ([#9451](https://github.com/andreaslind01/keptn/issues/9451)) ([8fcf4f2](https://github.com/andreaslind01/keptn/commit/8fcf4f27228e36ffd2cf2c24dc099725af6b0be9))
* **deps:** update reviewdog/action-setup action to v1.0.4 ([#9653](https://github.com/andreaslind01/keptn/issues/9653)) ([6827bdb](https://github.com/andreaslind01/keptn/commit/6827bdbee17fa2849142754312bfa61479aaa953))
* **deps:** update reviewdog/action-setup action to v1.0.5 ([#9725](https://github.com/andreaslind01/keptn/issues/9725)) ([1e82a51](https://github.com/andreaslind01/keptn/commit/1e82a518fd790d423782a201ad4e3e0b56adbe77))
* **deps:** update sigstore/cosign-installer action to v2.6.0 ([#8864](https://github.com/andreaslind01/keptn/issues/8864)) ([a8f8f1f](https://github.com/andreaslind01/keptn/commit/a8f8f1f612b7204c270036b91a87efe5e0b4d7f6))
* **deps:** update sigstore/cosign-installer action to v2.7.0 ([#8897](https://github.com/andreaslind01/keptn/issues/8897)) ([e981f2c](https://github.com/andreaslind01/keptn/commit/e981f2c1cb163cd48ab14934356311b37e37085a))
* **deps:** update sigstore/cosign-installer action to v2.8.0 ([#8976](https://github.com/andreaslind01/keptn/issues/8976)) ([2f040e4](https://github.com/andreaslind01/keptn/commit/2f040e4802fb3aaa63e4d4e18e983e44e1e81bd9))
* **deps:** update sigstore/cosign-installer action to v2.8.1 ([#9062](https://github.com/andreaslind01/keptn/issues/9062)) ([be4a968](https://github.com/andreaslind01/keptn/commit/be4a9680b4cd9d21d25373165b2ac005e273d41b))
* **deps:** update sigstore/cosign-installer action to v3 ([#9547](https://github.com/andreaslind01/keptn/issues/9547)) ([528deee](https://github.com/andreaslind01/keptn/commit/528deeef0fd5854dd4a120ccaf7557ea988cb157))
* **deps:** update sigstore/cosign-installer action to v3.0.2 ([#9625](https://github.com/andreaslind01/keptn/issues/9625)) ([cc66087](https://github.com/andreaslind01/keptn/commit/cc6608731937398011c57bf0c2f4e6df0ea72310))
* **deps:** update sigstore/cosign-installer action to v3.0.3 ([#9651](https://github.com/andreaslind01/keptn/issues/9651)) ([7b55e4d](https://github.com/andreaslind01/keptn/commit/7b55e4dbbd77a7874474288a8a2b34dbd876de85))
* **deps:** update sigstore/cosign-installer action to v3.0.5 ([#9700](https://github.com/andreaslind01/keptn/issues/9700)) ([db7231f](https://github.com/andreaslind01/keptn/commit/db7231f8afc306abd94f99f9620f276e49b6c3e6))
* **deps:** update storybook monorepo to v6.5.12 ([97be297](https://github.com/andreaslind01/keptn/commit/97be297bfe6904a520b1a7f9368f40d0fe094664))
* **deps:** update storybook monorepo to v6.5.12 (patch) ([#8853](https://github.com/andreaslind01/keptn/issues/8853)) ([97be297](https://github.com/andreaslind01/keptn/commit/97be297bfe6904a520b1a7f9368f40d0fe094664))
* **deps:** update storybook monorepo to v6.5.15 ([8fc1e21](https://github.com/andreaslind01/keptn/commit/8fc1e21bb725c8b30f7e1672f68e32ca42c2e170))
* **deps:** update storybook monorepo to v6.5.15 (patch) ([#9368](https://github.com/andreaslind01/keptn/issues/9368)) ([8fc1e21](https://github.com/andreaslind01/keptn/commit/8fc1e21bb725c8b30f7e1672f68e32ca42c2e170))
* **deps:** update test-summary/action action to v2 ([#9073](https://github.com/andreaslind01/keptn/issues/9073)) ([539339e](https://github.com/andreaslind01/keptn/commit/539339ef3da8e55d7968852a88ed01e0088f5871))
* **deps:** update tj-actions/changed-files action to v34 ([#9103](https://github.com/andreaslind01/keptn/issues/9103)) ([b91200d](https://github.com/andreaslind01/keptn/commit/b91200de093372b43c4d5f792ee6798b7a7e90d6))
* **deps:** update tj-actions/changed-files action to v35 ([#9359](https://github.com/andreaslind01/keptn/issues/9359)) ([e978673](https://github.com/andreaslind01/keptn/commit/e97867387316d87a614fc91384c55c29139b7216))
* **deps:** update to latest libgit2 version ([#9276](https://github.com/andreaslind01/keptn/issues/9276)) ([00d71c0](https://github.com/andreaslind01/keptn/commit/00d71c0d1683b1047ba7947b49088c5ba42ea4a1))
* **deps:** upgrade to libgit2-dev v1.5.1-r0 ([#9466](https://github.com/andreaslind01/keptn/issues/9466)) ([49bfbf2](https://github.com/andreaslind01/keptn/commit/49bfbf22e84f8480c77c00fd4d38ffb96b558bd1))
* Fix dependencies with go mod tidy ([#8863](https://github.com/andreaslind01/keptn/issues/8863)) ([e71a566](https://github.com/andreaslind01/keptn/commit/e71a566de2060c25249bc6242619bdf46012f55b))
* rebuild master ([#9642](https://github.com/andreaslind01/keptn/issues/9642)) ([76a997d](https://github.com/andreaslind01/keptn/commit/76a997d929b21986dfd39cc4dbf38f52bf6215fb))
* **release:** 0.20.0-next.0 ([#9036](https://github.com/andreaslind01/keptn/issues/9036)) ([2b4a93b](https://github.com/andreaslind01/keptn/commit/2b4a93b9f110affe8d8cb88e6f48c41a4d770ec7))
* **release:** 1.0.0 ([#9178](https://github.com/andreaslind01/keptn/issues/9178)) ([6db0fe6](https://github.com/andreaslind01/keptn/commit/6db0fe6b668b8096e1733951cfd1eaf6899bb997))
* **release:** 1.1.0 ([#9444](https://github.com/andreaslind01/keptn/issues/9444)) ([d84a688](https://github.com/andreaslind01/keptn/commit/d84a688bbeb26790b6feab4956ca60939600ca80))
* **release:** 1.2.0 ([#9464](https://github.com/andreaslind01/keptn/issues/9464)) ([afe2ac7](https://github.com/andreaslind01/keptn/commit/afe2ac73ce7c66acbe60d859250e7f4250c009ae))
* **release:** 1.3.0 ([#9514](https://github.com/andreaslind01/keptn/issues/9514)) ([a74bbf7](https://github.com/andreaslind01/keptn/commit/a74bbf73d4140c0def6b400243af2b1520c50b4e))
* **release:** 1.4.0 ([#9647](https://github.com/andreaslind01/keptn/issues/9647)) ([bc416c9](https://github.com/andreaslind01/keptn/commit/bc416c943da01074b112a9cb15b33a4e603e4554))
* **release:** 1.4.1 ([#9691](https://github.com/andreaslind01/keptn/issues/9691)) ([481a00f](https://github.com/andreaslind01/keptn/commit/481a00f568697842ed46bd6f164b2fb70e58a70c))
* **release:** 1.4.2 ([#9721](https://github.com/andreaslind01/keptn/issues/9721)) ([e332b8a](https://github.com/andreaslind01/keptn/commit/e332b8a1b2f6bc67d9fe2afc54acd6fc2c8bb43f))


### Refactoring

* **bridge:** Unify initial data retrieval ([#9173](https://github.com/andreaslind01/keptn/issues/9173)) ([6180974](https://github.com/andreaslind01/keptn/commit/6180974106283f75df887c81b0d54f600c6742cd))
